...
point revolves round bringing first-rate auto care techniques in south india.</p>
                        ...
                        <a href="<?php echo e(url('contact')); ?>" class="warranty-btn">SCHEDULE A REPAIR</a>
                    </div>
                </div>
                <div class="warranty-features">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single-feature">
                                <div class="icon-wrapper">
                                    <img src="<?php echo e(asset('web/img/info_icon_1.webp')); ?>" alt="">
                                </div>
                                <div class="txt">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-feature">
                                <div class="icon-wrapper">
                                    <img src="<?php echo e(asset('web/img/info_icon_2.webp')); ?>" alt="">
                                </div>
                                <div class="txt">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-feature">
                                <div class="icon-wrapper">
                                    <img src="<?php echo e(asset('web/img/info_icon_3.webp')); ?>" alt="">
                                </div>
                                <div class="txt">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team">
                            <div class="img-wrapper"><img src="<?php echo e(asset('web/img/team/IMG_3172.webp')); ?>" alt=""></div>
                            <div class="txt">
                                <h5>Sarath Kumar</h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team">
                            <div class="img-wrapper"><img src="<?php echo e(asset('web/img/team/IMG_3166.webp')); ?>" alt=""></div>
                            <div class="txt">
                                <h5>Rahul Nayar</h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team">
                            <div class="img-wrapper"><img src="<?php echo e(asset('web/img/team/IMG_3173.webp')); ?>" alt=""></div>
                            <div class="txt">
                                <h5>Biju Jacob</h5>
                                <span>MANAGING director</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team">
                            <div class="img-wrapper"><img src="<?php echo e(asset('web/img/team/IMG_3138.webp')); ?>" alt=""></div>
                            <div class="txt">
                                <h5>Man</h5>
                                <span>MANAGING director</span>
                            </div>
...
<?php echo $__env->make('layout.web-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelance\overdrive\laravel conversion\overdrive\resources\views/web/about.blade.php ENDPATH**/ ?>