                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> Logout</a>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="<?php echo e(url('add-gallery')); ?>" data-key="t-inbox">Add gallery</a></li>
                                    <li><a href="<?php echo e(url('view-gallery')); ?>" data-key="t-read-email">View</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="<?php echo e(url('add-careers')); ?>" data-key="t-inbox">Add Careers</a></li>
                                    <li><a href="<?php echo e(url('view-careers')); ?>" data-key="t-read-email">View</a></li>
                                    <li><a href="<?php echo e(url('view-inquiry')); ?>" data-key="t-read-email">View Inquiry</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="<?php echo e(url('view-quote')); ?>" data-key="t-inbox">View Quote</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="<?php echo e(url('view-contact')); ?>" data-key="t-read-email">View</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
...
<footer class="footer">
      ...
      <!-- lightbox js -->
      <script src="<?php echo e(asset('web/js/lightbox.min.js')); ?>"></script>
...
<?php /**PATH E:\Freelance\overdrive\laravel conversion\overdrive\resources\views/layout/admin-layout.blade.php ENDPATH**/ ?>