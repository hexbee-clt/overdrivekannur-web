                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.php" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                     <span class="logo-txt">Cremount</span>
                                </span>
                            </a>
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-xl-inline-block ms-1 fw-medium">
                                    ...
                                    include "./assets/layouts/connection.php";
                                        $us=$_SESSION["usename"];
                                        $sql_query = "select * from users_admin where username='".$us."'";
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <!-- <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="add-gallery.php" data-key="t-inbox">Add gallery</a></li>
                                    <li><a href="view-gallery.php" data-key="t-read-email">View</a></li>
                                </ul> -->
                            </li>
